...
export const TournamentCard = ({ tournament, currentUserId, defaultExpanded = false, badge }: TournamentCardProps) => {
	...
	return (
		<div
			className="relative overflow-hidden rounded-xl shadow-2xl p-4 backdrop-blur-sm bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900"
			style={{ minHeight: 160 }}
		>
			{badge !== undefined && (
			...
			<div className={`flex justify-between items-center ${badge !== undefined ? 'pt-5' : ''} pb-2`}>
